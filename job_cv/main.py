...
def main() -> None:
    ...
    apply_p.add_argument("-f", "--job-file", metavar="FILE", help="Path to a text file containing the job description")
    apply_p.add_argument("--cover-letter", action="store_true", help="Also generate a tailored cover letter")
    ...
    status_p.add_argument("status", choices=["applied", "interview", "offer", "rejected", "withdrawn"])
